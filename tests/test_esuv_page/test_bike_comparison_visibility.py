...
def test_bike_comparison(driver, esuv_url):
    ...
    try:
        ...
        print("Checking the bike images...")
        ...
        print("Checking the Close Comparison button...")
